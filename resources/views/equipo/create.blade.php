...
@section('content')
    <div class="container xl:max-w-4xl mx-auto my-0 px-4 bg-gradient-to-r from-red-50/50 to-red-300/50 shadow">
            ...
            <form method="POST" action="{{route('equips.store')}}"> {{--action="{{route('equips.storeTeam', $club->id)}}"--}}
              ...
              <div>
                ...
                <input
                  ...
                  type="text" name="name" placeholder="Indica el nom de l'equip" value="{{old('name')}}"/>
        ...
        <div class="flex flex-row-reverse">
          <a href="{{route('clubs.show', $club->id)}}" class="flex flex-row self-end px-4 py-2 text-rose-800 hover:text-red-400 type appearance-none mb-0">
